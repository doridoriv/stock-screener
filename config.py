...
DEFAULT_US_TICKERS = [
    ...
    "INTU", "COP", "ISRG", "PLTR", "GEV", "LMT", "TJX", "MDLZ", "BLK",
    "T", "ABBV", "GILD", "C", "BMY", "BKNG", "VRTX", "ADI", "MDT", "BA",
    "ELV", "ADP", "CI", "CB", "MMC", "REGN", "SYK", "DE"
]
...
US_NAME_MAP = {
    ...
    "UNH": "유나이티드헬스 그룹", "MA": "마스터카드", "HD": "홈디포", "PG": "프록터 앤 갬블", "COST": "코스트코",
    ...
    "TMO": "써모 피셔 사이언티픽", "ACN": "액센추어", "WFC": "웰스 파고", "AXP": "아메리칸 익스프레스", "GE": "제너럴 일렉트릭",
    "NKE": "나이키", "LIN": "린데", "PM": "필립 모리스", "ABT": "애보트 래보라토리", "TMUS": "티모바일",
    "CAT": "캐터필러", "TXN": "텍사스 인스트루먼트", "NOW": "서비스나우", "MS": "모건 스탠리", "DIS": "디즈니",
    "AMAT": "어플라이드 머티어리얼즈", "HON": "하니웰", "AMGN": "암젠", "UNP": "유니언 퍼시픽", "GS": "골드만삭스",
    "PFE": "화이자", "RTX": "레이시온 테크놀로지스", "LOW": "로우스", "NEE": "넥스트에라 에너지", "SPGI": "S&P 글로벌",
    "INTU": "인튜이트", "COP": "코노코필립스", "ISRG": "인튜이티브 서지컬", "PLTR": "팔란티어", "GEV": "GE 버노바",
    "LMT": "록히드 마틴", "TJX": "TJX 컴퍼니즈", "MDLZ": "몬델리즈 인터내셔널", "BLK": "블랙록",
...
COL_INFOS = [
    ...
    {"id": "peak_diff", "text": "최고점대비", "width": 90, "anchor": "e"},
    {"id": "ma200", "text": "200일선", "width": 90, "anchor": "e"},
    {"id": "diff", "text": "괴리율", "width": 80, "anchor": "e"},
    {"id": "rsi", "text": "RSI", "width": 70, "anchor": "e"},
    {"id": "per", "text": "PER", "width": 70, "anchor": "e"},
    {"id": "pbr", "text": "PBR", "width": 70, "anchor": "e"},
    {"id": "roe", "text": "ROE", "width": 70, "anchor": "e"},
    {"id": "peg", "text": "PEG", "width": 70, "anchor": "e"},
    {"id": "eps3y", "text": "EPS3Y", "width": 80, "anchor": "center"},
    {"id": "cagr", "text": "CAGR", "width": 70, "anchor": "e"},
    {"id": "comment", "text": "한줄평", "width": 250, "anchor": "w"}
]